    ...
    <main className="w-full min-h-screen bg-white">
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-3xl sm:text-4xl font-light mb-4 text-gray-900">Chicago Location</h1>
          <p className="text-base sm:text-lg text-gray-600 font-light">Urban garden oasis in the heart of the city</p>
        </div>
      </section>
